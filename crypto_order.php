...
if(isset($_GET['checkout_seller_id'])){
	...
	$proposal_delivery = $input->get('proposal_delivery');
	$proposal_revisions = $input->get('proposal_revisions');
	...
	$_SESSION['proposal_delivery'] = $proposal_delivery;
	$_SESSION['proposal_revisions'] = $proposal_revisions;
