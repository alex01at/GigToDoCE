  ...
  try {
    ...
    if($result){
       if($type == "proposal"){
           ...
           $_SESSION['proposal_delivery'] = $input->get('proposal_delivery');
           $_SESSION['proposal_revisions'] = $input->get('proposal_revisions');
...
public function mercadopago_execute($type){
